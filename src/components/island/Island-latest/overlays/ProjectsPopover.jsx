...
export default function ProjectsPopover({
  ...
  }, [projects, onMeasuredHeight, categoryTitle])
  ...
  return (
    <>
      {showHeader ? (
        <div className="" style={{ backgroundColor: '#2A1616' }}>
          <PixelFrameOverlay
            frameSrc="/frames/title-fram.png"
            slice={12}
            bw={9}
            pad={3}
            className="w-full mt-[3px] mb-[2px]"
          >
            <div
                ...
                projects.map((p, idx) => {
                  ...
                  const ItemButton = (
                    <button
                      ...
                      className="w-full text-center px-3 py-[7px] transition-colors cursor-pointer text-[11px] md:text-[12px] text-[10px] uppercase tracking-widest rounded-xl"
                      style={{
                        fontFamily: 'monospace',
                        letterSpacing: '0.14em',
                        textTransform: 'uppercase',
